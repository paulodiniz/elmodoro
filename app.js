	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Pomodoro'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
